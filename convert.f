...
c----------------------------------------------------------------------
      ...
      open(10,file='c.mnp.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='mnp.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='c.np_b.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='np_b.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='c.mixed.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='mixed.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='c.temp_p.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='temp_p.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='c.up_t.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='up_t.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='c.up_b.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='up_b.dat',status='unknown',
     x        form='unformatted')
...
c----------------------------------------------------------------------
      ...
      open(10,file='Diff_coeff.dat',
     x        form='unformatted',status='unknown')
     
      open(20,file='dc.dat',status='unknown',
     x        form='unformatted')
